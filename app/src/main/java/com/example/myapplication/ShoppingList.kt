...
data class Task(
    ...
    var dateAdded: String = SimpleDateFormat("yyyy-MM-dd", java.util.Locale.getDefault()).format(Date())
) {
...
data class Project(
    ...
    val dateCreated: String = SimpleDateFormat("yyyy-MM-dd", java.util.Locale.getDefault()).format(Date())
) {
                        ...
                        val tasks = (map["tasks"] as? List<*>)?.mapNotNull { taskMap ->
                            (taskMap as? Map<*, *>)?.let { task ->
                                Task(
                                    ...
                                    progressStatus = ProgressStatus.fromString(task["progressStatus"] as? String ?: ""),
